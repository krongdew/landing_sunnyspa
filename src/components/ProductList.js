...
const ProductList = ({ products }) => {
  ...
  const items = [
    // getItem(<CatProduct products={products} />, "1", <ContainerOutlined />, null, null, { color: '#ffffff' }),

    // getItem("Option 3", "3", <ContainerOutlined />, null, null, { color: '#ffffff' }),
    getItem(
      ...
      null,
      { color: "#ffffff" }
    ), // ส่ง style ของ Menu.Item
    // getItem("Navigation Two", "sub2", <AppstoreOutlined />, [
    //   getItem("Option 9", "9", null, null, null, { color: '#ffffff' }),
    //   getItem("Option 10", "10", null, null, null, { color: '#ffffff' }),
    //   getItem("Submenu", "sub3", null, [
    //     getItem("Option 11", "11", null, null, null, { color: '#ffffff' }),
    //     getItem("Option 12", "12", null, null, null, { color: '#ffffff' }),
    //   ], { color: '#ffffff' }), // ส่ง style ของ Menu.Item
    // ], { color: '#ffffff' }), // ส่ง style ของ Menu.Item
  ];
